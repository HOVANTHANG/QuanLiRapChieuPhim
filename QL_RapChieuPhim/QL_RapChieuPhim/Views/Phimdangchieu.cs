...
namespace QL_RapChieuPhim.Views
{
	public partial class Phimdangchieu : Form
	{
        ...
        DataTable dt; // DataTable chứa dữ liệu từ database
        string dtNgayChieu;
        string MaNV;
        ...
        {
          HashSet<string> uniqueMaPhims = new HashSet<string>(); //tạo 1 hashset để lưu mã phim duy nhất
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                // Tạo một panel mới với mỗi dòng dữ liệu trong DataTable
                ...
                {
                    // Nếu mã phim đã tồn tại, bỏ qua và không tạo panel mới
                    continue;
                }

                uniqueMaPhims.Add(maPhim);

                // Tạo các control để hiển thị thông tin phim
        ...
        // Hàm xử lý sự kiện khi DateTimePicker thay đổi giá trị
        ...
        */
        ...
        // Hàm xử lý sự kiện khi click vào panel`
        private void panel_Click(object sender, EventArgs e)
        {
            string NgayChieu = dtp_ngayChieu.Text;
            //ktra xem sender có phải là panel không
        ...
        private void txt_timkiem_phim_TextChanged(object sender, EventArgs e)
        {
            ...
            foreach (Control control in flowLayoutPanel1.Controls)
            {
                if (control is Bunifu.UI.WinForms.BunifuShadowPanel panel)
                {
                    ...
                    // Duyệt qua các control bên trong panel 

                    foreach (Control panelControl in panel.Controls)
                    {
                        //lấy tên phim, thể loại, năm sản xuất từ vị trí các label trong panel
