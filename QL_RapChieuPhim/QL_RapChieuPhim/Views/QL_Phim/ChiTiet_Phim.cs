...
namespace QL_RapChieuPhim.Views
{
    public partial class ChiTiet_Phim : Form
    {
        ...
        string[] strData; // tạo mảng để lưu dữ liệu từ form QL_Phim
        public ChiTiet_Phim(Views.QL_Phim qL_Phim, string[] str) 
        // str truyền dữ liệu từ form QL_Phim sang form ChiTiet_Phim khi bấm vào 1 dòng trong datagridview của form QL_Phim
        {
            this.qlPhim = qL_Phim;
            InitializeComponent();
            strData = str;
        ...
        private void txt_addDaodien_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt_MoTaPhim_TextChanged(object sender, EventArgs e)
        {
